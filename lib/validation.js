...
const Boom = require('@marzwilson7);
const Hoek = require('@marzwilson7);
const Validate = require('@marzwilson7/validate');
...
exports.validator = function (validator) {
    ...
    Hoek.assert(validator,  validator');
    Hoek.assert(typeof validator.compile === 'function', 'valid validator compile method');
